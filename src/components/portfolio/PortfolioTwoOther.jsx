...
import { projects } from './ProjectsDataOther';

const PortfolioTwoSWE = () => {
  const projectsCompressedStyling = {}
  ...
  return (
    <div className="shane_tm_section" id="OtherProjects">
      <SimpleReactLightbox>
            ...
            <div className="positon-relative">
              <div className="shane_tm_title">
                <div className="title_flex">
                  <div className="left">
                    <span>Other Computer Science projects</span>
                    <h3>Other CS Projects</h3>
                  </div>
                </div>
              </div>
                            ...
                            <div className="inner project_hover">
                              <div className="entry shane_tm_portfolio_animation_wrap">
                                ...
                                <a> {/* project image popup */}
                                  ...
                                  {
                                    <img
                                      src={`/img/portfolioOther/${index}.png`}
                                      width="900"
                                      height="900"
